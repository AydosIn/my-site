...
function getCardStyle(type: ContactCard["style"]): React.CSSProperties {
...
function isColored(type: ContactCard["style"]) {
  return type === "dark" || type === "blue" || type === "pink";
}
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "14px" }}>
        <div
          style={{
            ...
            flexShrink: 0,
            background: colored ? "#ffffff15" : "var(--bg)",
            border: colored ? "none" : "1px solid var(--border)",
          }}
        >
          {card.icon}
        </div>
        <div>
          <div
            style={{
              ...
              letterSpacing: "0.1em",
              marginBottom: "3px",
              color: colored ? "#ffffff66" : "var(--muted2)",
            }}
          >
            {card.label}
          </div>
  ...
  return (
    <>
      <FadeIn style={{ marginBottom: "40px" }}>
        ...
        <p style={{ fontSize: "13px", color: "var(--muted)", fontWeight: 300, lineHeight: 1.7 }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "10px", marginBottom: "12px" }}>
        {contacts.map((card, index) => (
          <FadeIn key={card.label} delay={0.04 + index * 0.05}>
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: "14px" }}>
              ...
              <div>
                ...
                <div className="font-syne" style={{ fontSize: "14px", fontWeight: 700, color: "var(--fg)" }}>@AydosIn</div>
              </div>
            </div>
      ...
      <FadeIn delay={0.28}>
        ...
        >
          <div>
            <div className="font-syne" style={{ fontSize: "18px", fontWeight: 800, color: "var(--fg)", marginBottom: "6px" }}>
              Let&apos;s connect
            </div>
